			...
			for (var ii = 0; ii < this.fields.length; ii++) {
				...
				if (fl === 'subcollection') {
					...
					try {
						...
						} else if (subcollectionString.indexOf("newsreader") + subcollectionString.indexOf("cssm") > -2){
							item['subcollection'] = 'Newsgroup';
						} else if (subcollectionString.indexOf("newsletters") > -1){
							item['subcollection'] = 'Technical Articles';
