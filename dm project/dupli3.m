...
X = randn(numberofmovies, totalfeatures);
Theta = randn(numberofusers, totalfeatures);
...
%set regularization
lambda = 5;
theta = findminx (@(t)(costfun(t, predefineduserratingvalues, predefineduserratingcheck, numberofusers, numberofmovies,totalfeatures, lambda)),initial_parameters, options);


X = reshape(theta(1:numberofmovies*totalfeatures), numberofmovies, totalfeatures);
Theta = reshape(theta(numberofmovies*totalfeatures+1:end),numberofusers, totalfeatures);
